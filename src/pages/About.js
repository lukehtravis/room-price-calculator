...
const About = () => {
    return (
        <div className="container">
            ...
            <br />
            <div>Room A = 300sqft => 300/<span class="red">400</span> => 0.75 => 0.75 x <span class="purple">$800</span> => $600</div>
            <div>Room B = 100sqft => 100/<span class="red">400</span> => 0.25 => 0.25 x <span class="purple">$800</span> => $200</div>
